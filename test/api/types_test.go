...
import (
	...
	nmstatev2 "github.com/nmstate/kubernetes-go-api/v2"
...
func testNetworkState(t *testing.T, expectedState []byte) {
	netState := &nmstatev2.NetworkState{}
	...
	requireStateEq(t, nmstatev2.ReplaceDeprecatedNames(expectedState), obtainedState)
}
