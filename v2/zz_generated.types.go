...
type BaseInterface struct {
	...
	// Driver  The driver of the specified network device.
...
type MacSecConfig struct {
	...
	Offload *MacSecOffload `json:"offload,omitempty"`
}
...
// +kubebuilder:validation:Enum="off";"phy";"mac";
type MacSecOffload string

const MacSecOffloadOff = MacSecOffload("off")
const MacSecOffloadPhy = MacSecOffload("phy")
const MacSecOffloadMac = MacSecOffload("mac")
...
type LibreswanConfig struct {
	...
	Rightcert      *string `json:"rightcert,omitempty"`
